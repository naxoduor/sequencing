...
public class ClustalOWorker implements Worker {
    ...
    public void tick() throws Exception {
        ...
        if (fasta == null || fasta.isBlank()) {
            throw new IllegalArgumentException(
                    "ClustalO input sequence '" + sequence.getId()
                            + "' has no residues");
        }
    ...
    public String align(String fasta) throws Exception {
        System.out.println("clustalo align");
        if (process == null) {
        ...
        System.out.println("collected outpputtttttt");
        ...
        if (exitCode != 0) {
            throw new RuntimeException(
                    "ClustalO failed with exit code " + exitCode +
                            ": " + errors
            );
        }
